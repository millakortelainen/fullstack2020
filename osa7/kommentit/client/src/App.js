...
import { initBlogs, newBlog, removeBlog, likeBlog, commentBlog } from './reducers/blogReducer'
import {
...
import { Container, Button, ThemeProvider, TextField, AppBar, Toolbar } from '@material-ui/core';
      ...
      <Container>
        <AppBar position="static">
          <Toolbar>
            ...
            {user.name} logged in <Button color='secondary' onClick={handleLogout}>logout</Button>
          </Toolbar>
        </AppBar>
        <h2>blog app</h2>
